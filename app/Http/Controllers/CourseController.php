...
class CourseController extends Controller
{
    ...
    public function index()
    {
        ...
        // dapat diakses oleh owner dan teacher
        // hanya menampilkan data teacher yang dimiliki saat ini
    ...
    public function store(StoreCourseRequest $request)
    {
        ...
        if (!$teacher) {
            return redirect()->route('admin.courses.index')->withErrors('unauthorized or invalid teachers.');
